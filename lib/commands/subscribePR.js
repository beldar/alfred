...
\nYou need to use this URL: `https://alfred-slackbot1.rhcloud.com/webhooks` and select these individual events: `Commit comment, Issue comment, Pull request, Pull request review, Pull request review comment`\
